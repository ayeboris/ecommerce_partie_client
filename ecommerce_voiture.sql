...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 02 mai 2022 à 12:49
...
(4, '0000', 'bobo', 'aye', 'bobo@g.com', 'bobo', '2022-04-27 12:46:39'),
(6, '0000', 'bobi', 'bobi', 'bobi@go.co', 'bobi', '2022-04-27 14:39:59');
...
(8, 6, 'testn', 'COCODY 2', '2022-04-28', 1);
...
CREATE TABLE IF NOT EXISTS `lignecom` (
  ...
  KEY `CODEART` (`CODEART`),
  KEY `NUMCOM` (`NUMCOM`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='cela liste la liste des comandes du clientquantite = ';
...
INSERT INTO `noter` (`CODECL`, `CODEART`, `NOTE`, `COMMENTAIRE`, `DATE_VOTE`) VALUES
(6, 2, 2, 'Tres bien gere', '2022-04-27 19:52:33'),
(6, 1, 3, 'très bonne voiture', '2022-04-27 21:33:55');
COMMIT;
